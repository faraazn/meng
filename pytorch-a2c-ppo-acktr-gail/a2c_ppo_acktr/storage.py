...
class RolloutStorage(object):
    ...
    def to(self, device):
        self.obs = {k: self.obs[k].to(device) for k in self.obs.keys()}
    ...
    def recurrent_generator(self, advantages, num_mini_batch):
        ...
        for start_ind in range(0, num_processes, num_envs_per_batch):
            ...
            obs_batch = {k: torch.stack(obs_batch[k], 1) for k in obs_batch.keys()}
            ...
            obs_batch = {k: _flatten_helper(T, N, obs_batch[k]) for k in obs_batch.keys()}
